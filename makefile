...
define SOURCES
main.cpp camera.cpp shader.cpp local_coordinate_entity.cpp mesh.cpp model.cpp sphere.cpp rectangular_prism.cpp time_integrator.cpp scene.cpp physics_entity.cpp \
