...
main.cpp camera.cpp shader.cpp sphere.cpp mesh.cpp time_integrator.cpp scene.cpp model.cpp physics_entity.cpp \
 explicit_euler.cpp symplectic_euler.cpp verlet.cpp \
constant_force.cpp gravity_force.cpp backward_euler.cpp midpoint_method.cpp net_force_accumulator.cpp 
endef
EXECUTABLE=sim.o
