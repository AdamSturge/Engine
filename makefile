...
SOURCES=main.cpp camera.cpp shader.cpp sphere.cpp mesh.cpp scene.cpp model.cpp physics_entity.cpp time_integrator.cpp explicit_euler.cpp constant_force.cpp gravity_force.cpp
EXECUTABLE=sim.o
